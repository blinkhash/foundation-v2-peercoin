...
const Loader = function(logger, configMain) {
  ...
  this.handleConfigs = function() {
    ...
    if (fs.existsSync(normalizedPath + 'peercoin.js')) {
      config = require(normalizedPath + 'peercoin.js');
      ...
      throw new Error('Unable to find peercoin.js file. Read the installation/setup instructions');
    }
    return config;
  };
};
