...
function mockClient() {
  ...
  client.id = 'test';
  client.addrPrimary = 'P9iJda86q6tWdHYsBXZGPGcxu5PYFGJDdb';
...
describe('Test pool functionality', () => {
  ...
  test('Test pool settings setup [2]', (done) => {
    ...
    mockSetupDaemons(pool, () => {
      ...
      pool.setupSettings(() => {
        expect(configCopy.primary.address).toBe('P9iJda86q6tWdHYsBXZGPGcxu5PYFGJDdb');
  ...
  test('Test pool settings setup [3]', (done) => {
    ...
    mockSetupDaemons(pool, () => {
      nock('http://127.0.0.1:9902')
        .post('/').reply(200, JSON.stringify([
          { id: 'nocktest', error: true, result: { isvalid: true, address: 'P9iJda86q6tWdHYsBXZGPGcxu5PYFGJDdb' }},
          { id: 'nocktest', error: null, result: { networkhashps: 0 }},
          { id: 'nocktest', error: null, result: { chain: 'main', difficulty: 0 }},
          { id: 'nocktest', error: null, result: { protocolversion: 1, connections: 1 }},
        ]));
  ...
  test('Test pool settings setup [4]', (done) => {
    ...
    mockSetupDaemons(pool, () => {
      nock('http://127.0.0.1:9902')
        .post('/').reply(200, JSON.stringify([
          { id: 'nocktest', error: null, result: { isvalid: false, address: 'P9iJda86q6tWdHYsBXZGPGcxu5PYFGJDdb' }},
          { id: 'nocktest', error: null, result: { networkhashps: 0 }},
          { id: 'nocktest', error: null, result: { chain: 'main', difficulty: 0 }},
          { id: 'nocktest', error: null, result: { protocolversion: 1, connections: 1 }},
        ]));
  ...
  test('Test pool manager setup [8]', (done) => {
    ...
    pool.on('pool.log', (type, text) => {
      ...
      if (response.length === 2) {
        ...
        expect(response[0][1]).toBe('Submitted a primary block (Peercoin:1) successfully to Peercoin\'s daemon instance(s)');
  ...
  test('Test pool block polling setup [1]', (done) => {
    ...
    pool.on('pool.log', (type, text) => {
      ...
      if (response.length === 2) {
        ...
        expect(response[1][1]).toBe('Requested template from primary chain (Peercoin:2) via RPC polling');
        done();
      }
    });
    mockSetupDaemons(pool, () => {
  ...
  test('Test pool block polling setup [2]', (done) => {
    ...
    pool.on('pool.log', (type, text) => {
      ...
      if (response.length === 3) {
        ...
        expect(response[2][1]).toBe('Requested template from primary chain (Peercoin:1) via RPC polling');
        done();
      }
    });
    mockSetupDaemons(pool, () => {
  ...
  test('Test pool stratum setup [6]', (done) => {
    ...
    pool.on('pool.log', (type, text) => {
      ...
      if (response.length === 2) {
        ...
        expect(response[0][1]).toBe('Network difficulty (0) is lower than the difficulty on port 3002 (32)');
        expect(response[1][0]).toBe('log');
        expect(response[1][1]).toBe('Difficulty update queued for worker: P9iJda86q6tWdHYsBXZGPGcxu5PYFGJDdb (8)');
        pool.network.stopNetwork();
      }
    });
    pool.on('client.socket.success', () => {
  ...
  test('Test pool stratum setup [7]', (done) => {
    ...
    pool.on('pool.log', (type, text) => {
      ...
      if (response.length === 2) {
        ...
        expect(response[0][1]).toBe('Network difficulty (0) is lower than the difficulty on port 3002 (32)');
        expect(response[1][0]).toBe('log');
        expect(response[1][1]).toBe('Difficulty updated successfully for worker: P9iJda86q6tWdHYsBXZGPGcxu5PYFGJDdb (8)');
        pool.network.stopNetwork();
      }
    });
    pool.on('client.socket.success', () => {
    ...
    mockSetupDaemons(pool, () => {
      nock('http://127.0.0.1:9902')
        ...
        .reply(200, JSON.stringify({
          id: 'nocktest',
          error: null,
          result: { isvalid: true, address: 'P9iJda86q6tWdHYsBXZGPGcxu5PYFGJDdb' }
        }));
      pool.checkWorker(pool.primary.daemon, 'P9iJda86q6tWdHYsBXZGPGcxu5PYFGJDdb', (valid) => {
  ...
  test('Test pool stratum authentication [2]', (done) => {
    ...
    mockSetupDaemons(pool, () => {
      ...
      pool.checkWorker(pool.primary.daemon, 'P9iJda86q6tWdHYsBXZGPGcxu5PYFGJDdb.worker1', (valid) => {
        expect(valid).toBe(true);
        done();
      });
    });
  ...
  test('Test pool stratum authentication [3]', (done) => {
    ...
    mockSetupDaemons(pool, () => {
      ...
      pool.checkPrimaryWorker('0.0.0.0', 3001, 'P9iJda86q6tWdHYsBXZGPGcxu5PYFGJDdb', (valid) => {
        expect(valid).toBe(true);
        done();
      });
    });
    ...
    mockSetupDaemons(pool, () => {
      nock('http://127.0.0.1:9902')
        ...
        .reply(200, JSON.stringify({
          id: 'nocktest',
          error: null,
          result: { isvalid: false, address: 'P9iJda86q6tWdHYsBXZGPGcxu5PYFGJDdb' }
        }));
      pool.checkPrimaryWorker('0.0.0.0', 3001, 'P9iJda86q6tWdHYsBXZGPGcxu5PYFGJDdb', () => {}, (result) => {
  ...
  test('Test pool stratum authentication [6]', (done) => {
    ...
    mockSetupDaemons(pool, () => {
      ...
      pool.checkAuxiliaryWorker('0.0.0.0', 3001, 'P9iJda86q6tWdHYsBXZGPGcxu5PYFGJDdb', (valid) => {
        expect(valid).toBe(true);
        done();
      });
    });
  ...
  test('Test pool stratum authentication [7]', (done) => {
    ...
    mockSetupDaemons(pool, () => {
      ...
      pool.checkAuxiliaryWorker('0.0.0.0', 3001, 'P9iJda86q6tWdHYsBXZGPGcxu5PYFGJDdb', () => {}, (result) => {
        expect(result).toStrictEqual({ 'error': null, 'authorized': false, 'disconnect': false });
        done();
      });
    });
  ...
  test('Test pool stratum authentication [10]', (done) => {
    ...
    mockSetupDaemons(pool, () => {
      ...
      pool.authorizeWorker('0.0.0.0', 3001, 'P9iJda86q6tWdHYsBXZGPGcxu5PYFGJDdb', null, 'test', (result) => {
  ...
  test('Test pool stratum authentication [11]', (done) => {
    ...
    mockSetupDaemons(pool, () => {
      ...
      pool.authorizeWorker('0.0.0.0', 3001, 'P9iJda86q6tWdHYsBXZGPGcxu5PYFGJDdb', 'P9iJda86q6tWdHYsBXZGPGcxu5PYFGJDdb', 'test', (result) => {
        expect(result).toStrictEqual({ 'error': null, 'authorized': true, 'disconnect': false });
        done();
      });
    });
  ...
  test('Test pool workers handling [1]', () => {
    ...
    const blocks1 = {
      ...
      miner: 'P9iJda86q6tWdHYsBXZGPGcxu5PYFGJDdb',
      worker: 'P9iJda86q6tWdHYsBXZGPGcxu5PYFGJDdb.worker1',
      category: 'immature',
      confirmations: 3,
    ...
    const worker1 = {
      ...
      miner: 'P9iJda86q6tWdHYsBXZGPGcxu5PYFGJDdb',
      worker: 'P9iJda86q6tWdHYsBXZGPGcxu5PYFGJDdb.worker4',
      identifier: 'master',
      invalid: 0,
      round: '15c8343c-9751-4c67-aafa-29ff296da484',
      solo: false,
    ...
    const expected = { 'P9iJda86q6tWdHYsBXZGPGcxu5PYFGJDdb_false_primary': { 'immature': 9999.996, 'generate': 0 }};
  ...
  test('Test pool workers handling [2]', () => {
    ...
    const expected = { 'P9iJda86q6tWdHYsBXZGPGcxu5PYFGJDdb_false_primary': { 'generate': 0, 'immature': 19999.992 }};
  ...
  test('Test pool workers handling [3]', () => {
    ...
    worker2.miner = 'P9iJda86q6tWdHYsBXZGPGcxu5PYFGJDdc';
    worker2.worker = 'P9iJda86q6tWdHYsBXZGPGcxu5PYFGJDdc.worker4';
    const expected = {
      'P9iJda86q6tWdHYsBXZGPGcxu5PYFGJDdb_false_primary': { 'immature': 4999.998, 'generate': 0 },
      'P9iJda86q6tWdHYsBXZGPGcxu5PYFGJDdc_false_primary': { 'immature': 4999.998, 'generate': 0 }};
  ...
  test('Test pool workers handling [4]', () => {
    ...
    worker2.times = 49.1;
    const expected = {
      'P9iJda86q6tWdHYsBXZGPGcxu5PYFGJDdb_false_primary': { 'immature': 8474.10655446, 'generate': 0 },
      'P9iJda86q6tWdHYsBXZGPGcxu5PYFGJDdc_false_primary': { 'immature': 1525.88944554, 'generate': 0 }};
    pool.handlePrimaryWorkers([blocks1], [[worker1, worker2]], (results) => {
      expect(results).toStrictEqual(expected);
    });
  });
  ...
  test('Test pool workers handling [5]', () => {
    ...
    const expected = { 'P9iJda86q6tWdHYsBXZGPGcxu5PYFGJDdb_false_primary': { 'generate': 9999.996, 'immature': 0 }};
    pool.handlePrimaryWorkers([blocks1], [[worker1]], (results) => {
      expect(results).toStrictEqual(expected);
    });
  });
  ...
  test('Test pool workers handling [6]', () => {
    ...
    const expected = { 'P9iJda86q6tWdHYsBXZGPGcxu5PYFGJDdb_false_primary': { 'immature': 0, 'generate': 19999.992 }};
    pool.handlePrimaryWorkers([blocks1, blocks1], [[worker1], [worker1]], (results) => {
      expect(results).toStrictEqual(expected);
    });
  });
  ...
  test('Test pool workers handling [10]', () => {
    ...
    const expected = { 'P9iJda86q6tWdHYsBXZGPGcxu5PYFGJDdb_false_auxiliary': { 'immature': 9999.996, 'generate': 0 }};
  ...
  test('Test pool workers handling [11]', () => {
    ...
    const expected = { 'P9iJda86q6tWdHYsBXZGPGcxu5PYFGJDdb_false_auxiliary': { 'generate': 0, 'immature': 19999.992 }};
  ...
  test('Test pool workers handling [12]', () => {
    ...
    worker2.worker = 'P9iJda86q6tWdHYsBXZGPGcxu5PYFGJDdc.worker4';
    const expected = {
      'P9iJda86q6tWdHYsBXZGPGcxu5PYFGJDdb_false_auxiliary': { 'immature': 4999.998, 'generate': 0 },
      'P9iJda86q6tWdHYsBXZGPGcxu5PYFGJDdc_false_auxiliary': { 'immature': 4999.998, 'generate': 0 }};
  ...
  test('Test pool workers handling [13]', () => {
    ...
    worker2.times = 49.1;
    const expected = {
      'P9iJda86q6tWdHYsBXZGPGcxu5PYFGJDdb_false_auxiliary': { 'immature': 8474.10655446, 'generate': 0 },
      'P9iJda86q6tWdHYsBXZGPGcxu5PYFGJDdc_false_auxiliary': { 'immature': 1525.88944554, 'generate': 0 }};
    pool.handleAuxiliaryWorkers([blocks1], [[worker1, worker2]], (results) => {
      expect(results).toStrictEqual(expected);
    });
  });
  ...
  test('Test pool workers handling [14]', () => {
    ...
    const expected = { 'P9iJda86q6tWdHYsBXZGPGcxu5PYFGJDdb_false_auxiliary': { 'generate': 9999.996, 'immature': 0 }};
    pool.handleAuxiliaryWorkers([blocks1], [[worker1]], (results) => {
      expect(results).toStrictEqual(expected);
    });
  });
  ...
  test('Test pool workers handling [15]', () => {
    ...
    const expected = { 'P9iJda86q6tWdHYsBXZGPGcxu5PYFGJDdb_false_auxiliary': { 'immature': 0, 'generate': 19999.992 }};
    pool.handleAuxiliaryWorkers([blocks1, blocks1], [[worker1], [worker1]], (results) => {
      expect(results).toStrictEqual(expected);
    });
  });
